...
print('digite períodos com variação maior de 3 anos')
...
print('a maior baixa do primeiro semestre de ' +  str(a2) +' foi em: ' + y + '. No valor de : ', k)
...
print('a maior baixa do segundo semestre de ' +  str(a2) +' foi em: ' + y + '. No valor de : ', z)
...
print('a maior baixa do primeiro semestre de ' +  str(a2 -1) + ' foi em: ' + y + '. No valor de : ', k)
...
print('a maior baixa do segundo semestre de ' +  str(a2 -1)+  ' foi em: ' + y + '. No valor de : ', z)
...
for i in range(len(primeiro_semestre_a2)):
    if primeiro_semestre_a2[i][3] > k:
        y = primeiro_semestre_a2[i][0]
        k = primeiro_semestre_a2[i][3]
print('o maior valor do primeiro semestre de ' + str(a2) + ' foi em: ' + y + '. No valor de : ', k)
z = segundo_semestre_a2[0][3]
for i in range(len(segundo_semestre_a2)):
    if segundo_semestre_a2[i][3] > z:
        y = segundo_semestre_a2[i][0]
...
for i in range(len(primeiro_semestre_ano_anterior)):
    if primeiro_semestre_ano_anterior[i][3] > k:
        y = primeiro_semestre_ano_anterior[i][0]
        k = primeiro_semestre_ano_anterior[i][3]
print('o maior valor do primeiro semestre de ' + str(a2 -1)+ ' foi em: ' + y + '. No valor de : ', k)
z = segundo_semestre_ano_anterior[0][3]
for i in range(len(segundo_semestre_ano_anterior)):
    if segundo_semestre_ano_anterior[i][3] > z:
        y = segundo_semestre_ano_anterior[i][0]
        z = segundo_semestre_ano_anterior[i][3]
print('o maior valor segundo semestre de ' + str(a2 -1) + ' foi em: ' + y + '. No valor de : ', z)
...
del eixo_y2[0:k]
fig, ax =plt.subplots()
ax.plot(eixo_x, eixo_y, label = 'maior baixa do dia')
#ax.plot(eixo_x, eixo_y1)
ax.plot(eixo_x, eixo_y2, label = 'maior alta do dia')
lista_grf =[]
i = 2
x=0
while i >=0:
